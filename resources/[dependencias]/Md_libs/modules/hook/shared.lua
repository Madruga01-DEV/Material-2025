...
function Md.hook.registerAction(name,fct,priority)
...
exports('registerAction',Md.hook.registerAction)

---@param name string the name of the action
---@param ...? any
function Md.hook.doActions(name,...)
...
function Md.hook.registerFilter(name,fct,priority)
...
---@param ...? any
function Md.hook.applyFilters(name,value,...)
...
-- DEPRECIATED
-------------
function Md.hook.RegisterFilter(...)
  Md.hook.registerFilter(...)
  CreateThread(function()
    Wait(3000)
    oprint('RegisterFilter with "R" in uppercase is depreciated. Use registerFilter with "r" in lowercase !')
  end)
end
function Md.hook.RegisterAction(...)
  Md.hook.registerAction(...)
  CreateThread(function()
    Wait(3000)
