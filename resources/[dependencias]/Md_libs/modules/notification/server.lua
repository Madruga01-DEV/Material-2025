...
function Md.notif.right(source,text, dict, icon, color, duration,soundset_ref,soundset_name)
...
---@param soundset_ref? string The dictionnary of the soundset
---@param soundset_name? string The name of the soundset
function Md.notif.left(source,title, text, dict, icon, color, duration,soundset_ref,soundset_name)
...
---@param source integer the source ID of the player
---@param text string The text of the notification
function Md.notif.rightSuccess(source,text)
  Md.notif.right(source,text,"hud_textures","check","COLOR_GREEN")
end

---@param source integer the source ID of the player
---@param text string The text of the notification
function Md.notif.rightError(source,text)
  Md.notif.right(source,text,"menu_textures", "cross","COLOR_RED")
end
