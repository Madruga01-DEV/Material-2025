...
function Md.database.addTable(tableName, definition)
...
function Md.database.addTrigger(triggerName,definition)
...
function Md.database.addColumn(tableName,name,definition)
